...
public class RSButtonMetro extends JButton implements MouseListener, MouseMotionListener {
     ...
     */
    private Color colorNormal = new Color(79, 97, 143);
    private Color colorPressed = new Color(137, 84, 25);
    private Color colorHover = new Color(217, 189, 107);
...
//        this.setBorderPainted(false);
    ...
    public void setColorSinPresionar() {
        setColorNormal(new Color(79, 97, 143));
        setColorHover(new Color(217, 189, 107));
        setColorPressed(new Color(137, 84, 25));
    }

    public void setColorPresionado() {
        setColorNormal(new Color(175, 120, 59));
        setColorHover(new Color(217, 189, 107));
        setColorPressed(new Color(137, 84, 25));
    }
