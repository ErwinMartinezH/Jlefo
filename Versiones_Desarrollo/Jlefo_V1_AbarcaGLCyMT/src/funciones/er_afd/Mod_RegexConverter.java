...
public class Mod_RegexConverter {
    ...
    /**
     * Metodo para abreviar el operador ? equivalente a |€
     *
    ...
    public String abreviaturaInterrogacion(String regex) {
        for (int i = 0; i < regex.length(); i++) {
            ...
            if (ch.equals('?')) {
                if (regex.charAt(i - 1) == ')') {
                    regex = insertCharAt(regex, i, "|" + EPSILON + ")");
    ...
    /**
     * Método para balancear parentesis en caso de que esté mal ingresada la
     * expresión regular
     *
...
//        
    /**
     * Convertir una expresión regular de notación infix a postfix con el
