    ...
    public V_tabs() {
        addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                if (indicePestaña.getIndice() > 1) {//Si hay más de una pestaña activa
                    if (lienzo.getTipoPanel().equals(ER)) {//Si la pestaña activa es de expresiones regulares
                        C_interfaz.deslizarMenu(ER);//Deslizar el menú
